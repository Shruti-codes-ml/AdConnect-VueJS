            ...
            <table class="table table-hover">
                ...
                <tbody>
                    <tr v-for="ad_request in AdRequests" :key="ad_request.id">
                        ...
                        <td>
                            <button v-if="ad_request.sponsor_accepted && ad_request.influencer_accepted" :class="{'btn btn-success': ad_request.payment_status === true, 'btn btn-secondary': ad_request.payment_status !== true}" :disabled="ad_request.payment_status !== true">
                                <i :class="ad_request.payment_status === true ? 'fa-solid fa-thumbs-up' : 'fa-solid fa-money-bill'"></i>
                                {{ ad_request.payment_status === true ? 'Payment Done' : 'Awaiting Payment' }}
                            </button>
                            <button v-else-if="ad_request.influencer_accepted && ad_request.sponsor_accepted !== false" class="btn btn-success" disabled>
