    ...
    <div class="p-4 bg-white bg-opacity-75 rounded shadow mt-3">
      ...
      <div v-if="isAuthenticated">
          ...
          <form @submit.prevent="UpdateCampaign">
            <h5 class="display-5">Update Campaign</h5>
            ...
            <div class="form-group p-2">
                ...
                <input type="date" v-model="start_date" class="form-control" required disabled>
            </div>
            <div class="form-group p-2">
            ...
            <div class="form-group p-2">
                ...
                <input type="number" v-model="payment_amount" class="form-control" min="0" required>
            </div>

            <div class="d-flex p-2 gap-3">
                <button class="btn btn-info"><i class="fa-regular fa-pen-to-square"></i> Update Campaign </button>
...
export default {
    ...
    methods:{
        ...
        fetchCampaignInfo(){
            ...
            axios
                .get(`/fetch_campaign_info/${this.campaignId}`, {
                    headers: {
                        Authorization: `Bearer ${accessToken}`,
                    },
                })
                .then((response) => {
                    this.campaign_name= response.data.name,
        ...
        UpdateCampaign(){
            ...
            axios
                .post('/sponsor/update_campaign', data, {
                    headers: {
                        Authorization: `Bearer ${accessToken}`,
